                    ...
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="#" class="logo footer-logo">
                                <img src="assets/images/organic-3.png" alt="biolife logo" width="135" height="34">
                            </a>
                            <div class="footer-phone-info">
                                <i class="biolife-icon icon-head-phone"></i>
                                <p class="r-info">
                                    <span>Có thắc mắc?</span>
                            ...
                            <div class="newsletter-block layout-01">
                                ...
                                <div class="form-content">
                                    <form action="#" name="newsletter-footer">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">123 Đường ABC, Quận XYZ, TP. Hồ Chí Minh</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Điện thoại: (+84) 123 456 789</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email: contact@fishshop.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-clock"></i>
                                            <b class="desc">Giờ mở cửa: 7 ngày trong tuần từ 8:00 AM</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
