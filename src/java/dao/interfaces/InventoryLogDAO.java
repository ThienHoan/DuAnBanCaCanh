...
public interface InventoryLogDAO {
    ...
    /**
     * Get inventory logs by reference ID with product information
     * @param referenceId Reference ID (e.g., order ID)
     * @param referenceType Reference type (e.g., "order_admin_confirmed")
     * @return List of inventory logs with the specified reference ID and type
     */
    List<InventoryLog> getInventoryLogsByReferenceId(int referenceId, String referenceType);
} 